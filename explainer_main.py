...
def main():
    ...
    timestep=cg_dict["feat"].shape[2]
    feature_num = cg_dict["feat"].shape[3]
    ...
    cg_dict["feat"]=np.expand_dims(cg_dict["feat"], axis=0)
    cg_dict["label"]=np.expand_dims(cg_dict["label"], axis=0)
    cg_dict["pred"]=np.expand_dims(cg_dict["pred"], axis=0)
